...
export class JwtInterceptor implements HttpInterceptor{
    ...
    intercept(req: HttpRequest<any>, next: HttpHandler): Observable<HttpEvent<any>> {
        ...
        if(this.authService.userSessionExpires()){this.authService.logout();}

        if(this.authService.isLoggedIn()){req = this.appendToken(req, this.authService.getTokens().accessToken);}
